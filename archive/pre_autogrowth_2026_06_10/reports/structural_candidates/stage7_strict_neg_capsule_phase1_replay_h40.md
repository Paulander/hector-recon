...
- `8/8/R7/8/2k5/8/8/3K4 w - - 2 2` -> result `max_plies` in `40` plies, selected `krk.post_box_shrink_continuation` move `a6a8`, plan-supported `48`
- `8/8/8/R7/4k3/8/3K4/8 w - - 2 2` -> result `max_plies` in `40` plies, selected `krk.post_box_shrink_continuation` move `a5h5`, plan-supported `48`
