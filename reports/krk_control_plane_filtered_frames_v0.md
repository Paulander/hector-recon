...
- Benchmark role counts: `{'internal_monitor_quality_analysis': 33, 'plan_window_context_only_stage7': 4, 'sequence_policy_context_only_stage7': 3, 'strategy_arbitration_benchmark': 28}`
- Strategy-ready frames: `28`
- Strategy-ready by stage: `{'stage7': 4, 'stage5': 8, 'stage6': 10, 'stage4': 6}`
