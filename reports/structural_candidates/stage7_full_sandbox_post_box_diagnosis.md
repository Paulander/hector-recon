...
Records: `25`
Conversion failures: `9`
Unique failed post-reply states: `3`

## Buckets

- `box_shrink_visible_confirmed_mate`: 6
- `box_shrink_visible_confirmed_max_plies`: 9
...
- Diagnosis labels: `post_box_shrink_continuation_gap`, `topology_present_untrained_or_miscalibrated`
