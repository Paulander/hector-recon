...
- `krk.stage0_basin` selected 10 times
...
- `krk.box_shrink` via `krk.stage0_basin` resulted in `max_plies` (count=10, gap=False, conflict=False)

Selected successor by outcome:
- `krk.stage0_basin:max_plies`: 10
