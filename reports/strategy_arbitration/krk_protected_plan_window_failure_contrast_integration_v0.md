...
- validation_status: `protected_plan_window_failure_contrast_outputs_valid_ready_for_integration`
...
- skipped_counts: `{'not_conversion_failure': 6}`
...
- recommended_next_step: `collect_additional_reviewed_protected_plan_window_failure_contrasts`
