...
- `row_count`: `35`
- `state_count`: `35`
- `label_counts`: `{'selected_owner_converted': 27, 'selected_owner_failed': 8}`
...
- `recommended_next_step`: `probe_targeted_refreshed_context_enriched_ownership_selection_features`
