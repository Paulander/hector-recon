#!/usr/bin/env python3
"""Review KRK strategy-sequence dataset v3 context integration."""
...
OUT_JSON = Path("reports/strategy_arbitration/krk_strategy_sequence_dataset_v3_context_review.json")
OUT_MD = Path("reports/strategy_arbitration/krk_strategy_sequence_dataset_v3_context_review.md")
...
def build_payload(
    ...
    context_ready = (
        ...
        and trace_sources.get("stage5_6_candidate_generation_refresh", 0) > 0
        and trace_sources.get("repair_monitor_observation", 0) > 0
    )
    return {
        "schema_version": "krk_strategy_sequence_dataset_v3_context_review.v1",
        ...
        "decision": {
            "status": (
                ...
                if context_ready
                else "strategy_sequence_dataset_v3_context_blocked"
            ),
            ...
            "recommended_next_step": (
                ...
                if context_ready
                else "fix_dataset_v3_context_integration"
            ),
        },
    }
