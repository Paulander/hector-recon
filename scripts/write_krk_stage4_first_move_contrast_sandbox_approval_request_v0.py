    ...
    return {
        ...
        **COMMON_FALSE_FLAGS,
        ...
        "required_scope_if_user_approves": {
            ...
            "sandbox_scope_id": SANDBOX_SCOPE_ID,
...
def write_markdown(payload: dict[str, Any]) -> str:
    ...
    lines.extend(
        [
            ...
            f"- sandbox_scope_id: `{required['sandbox_scope_id']}`",
            f"- default_off: `{required['default_off']}`",
            f"- default_enabled: `{required['default_enabled']}`",
            f"- runtime_change_class: `{required['runtime_change_class']}`",
            f"- exact_state_or_exact_move_exception: `{required['exact_state_or_exact_move_exception']}`",
            f"- runtime_dtm_or_tablebase_lookup: `{required['runtime_dtm_or_tablebase_lookup']}`",
            f"- hidden_python_controller: `{required['hidden_python_controller']}`",
