...
def write_markdown(payload: dict[str, Any]) -> str:
    ...
    lines.extend(
        [
            ...
            f"- source_stage_counts: `{primary['scope']['source_stage_counts']}`",
            ...
            f"- execution_readiness_recomputed_live: `{primary['scope']['execution_readiness_recomputed_live']}`",
            f"- per_job_timeout_seconds: `{primary['scope']['per_job_timeout_seconds']}`",
            f"- refresh_after_run: `{primary['scope']['refresh_after_run']}`",
            ...
            f"- timed_out_job_count: `{primary['scope']['timed_out_job_count']}`",
            f"- post_success_refresh: `{primary['scope']['post_success_refresh']}`",
            f"- runtime_behavior_changed: `{primary['scope']['runtime_behavior_changed']}`",
            f"- runtime_direct_routing: `{primary['scope']['runtime_direct_routing']}`",
            f"- hidden_python_controller: `{primary['scope']['hidden_python_controller']}`",
            f"- stage7_training_rows: `{primary['scope']['stage7_training_rows']}`",
            f"- stage7_promotion_allowed: `{primary['scope']['stage7_promotion_allowed']}`",
            f"- stage8_training_allowed: `{primary['scope']['stage8_training_allowed']}`",
            ...
            f"- default_off: `{secondary['scope']['default_off']}`",
            f"- default_enabled: `{secondary['scope']['default_enabled']}`",
            f"- runtime_change_class: `{secondary['scope']['runtime_change_class']}`",
            f"- exact_state_or_exact_move_exception: `{secondary['scope']['exact_state_or_exact_move_exception']}`",
            f"- runtime_dtm_or_tablebase_lookup: `{secondary['scope']['runtime_dtm_or_tablebase_lookup']}`",
            f"- hidden_python_controller: `{secondary['scope']['hidden_python_controller']}`",
            f"- selector_training_allowed: `{secondary['scope']['selector_training_allowed']}`",
            f"- provider_suppression_allowed: `{secondary['scope']['provider_suppression_allowed']}`",
            f"- broad_stage0_penalty_allowed: `{secondary['scope']['broad_stage0_penalty_allowed']}`",
            f"- gameplay_topology_mutation: `{secondary['scope']['gameplay_topology_mutation']}`",
            f"- stage7_promotion_allowed: `{secondary['scope']['stage7_promotion_allowed']}`",
            f"- stage8_training_allowed: `{secondary['scope']['stage8_training_allowed']}`",
