...
HANDOFF_PROFILE_VALIDATION_FLAGS = [
    "--composition-profile",
    "handoff_composition_v1",
    "--use-profile-validation-defaults",
    "--stagnation-breaker-king-support-bonus",
    "2.0",
...
def build_payload() -> dict[str, Any]:
    ...
    promotion_eval_command = [
        ...
        "--guardrail-control-artifact",
        outputs["stage5_base_control"],
        "--min-mate-rate",
        "0.65",
        "--max-max-plies-rate",
        "0.25",
    ...
    stage6_candidate_eval_command = [
        ...
        "7",
        "--source-stage-names",
        "Opposition_Approach,Tempo_Wait,King_Close_1",
        "--playout-max-plies",
        "40",
        *HANDOFF_PROFILE_VALIDATION_FLAGS,
        "--json-output",
    ...
    stage5_guardrail_eval_command = [
        ...
        "7",
        "--source-stage-names",
        "Fence_Established,Anchored_Cut,Edge_Cut_Hold",
        "--playout-max-plies",
        "40",
        *HANDOFF_PROFILE_VALIDATION_FLAGS,
        "--json-output",
    ...
    return {
        ...
        "commands": {
            ...
            "stage6_candidate_eval": stage6_candidate_eval_command,
            "stage5_guardrail_eval": stage5_guardrail_eval_command,
            "stage5_base_control_eval": stage5_base_control_command,
            "promotion_eval": promotion_eval_command,
            "validation": validation_commands,
        },
        "validation_profile_required_flags": HANDOFF_PROFILE_VALIDATION_FLAGS,
