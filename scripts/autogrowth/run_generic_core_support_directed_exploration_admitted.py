#!/usr/bin/env python3
"""Run the frozen generic-core support-directed exploration experiment with frozen admission."""
...
DEFAULT_OUTPUT = Path(
    ...
    "support_directed_exploration_admitted_20260713.json"
)
CANDIDATE_SEEDS = tuple(range(20262201, 20262241))
ADMITTED_COUNT = 20
ADMISSION_OUTPUT = Path(
    "reports/autogrowth/generic_core/"
    "support_directed_exploration_admission_20260713.json"
)
DEMANDS = (2,)
ARMS = (
    "fixed_8_ranked",
...
CONTRACT = Path(
    "docs/autogrowth/"
    "GENERIC_CORE_SUPPORT_DIRECTED_EXPLORATION_ADMITTED_WORK_PACKAGE_20260713.md"
)
...
def main() -> int:
    ...
    admission_payload = {
        "schema_version": (
            "recon_support_directed_exploration_admission_manifest.v1"
        ),
    ...
    if not admission_pass:
        payload = {
            "schema_version": (
                "recon_support_directed_exploration_admitted_raw.v1"
            ),
