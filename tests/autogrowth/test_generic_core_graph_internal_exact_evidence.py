...
RUNNER = runpy.run_path(
    str(ROOT / "scripts/autogrowth/run_generic_core_graph_internal_exact_evidence.py")
)
...
def test_target_diagnostics_reconstruct_exact_four_post_hoc() -> None:
    ...
    RUNNER["_configure_arm"](
        policy, "rent_batch_4_graph_exact_directed"
    )
...
def test_fresh_admission_protocol_constants_are_frozen() -> None:
    assert RUNNER["CANDIDATE_SEEDS"] == tuple(range(20262301, 20262341))
