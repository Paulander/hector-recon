...
RUNNER = runpy.run_path(
    str(ROOT / "scripts/autogrowth/run_generic_core_support_directed_exploration.py")
)
...
def test_fresh_protocol_constants_are_frozen() -> None:
    assert RUNNER["SEEDS"] == tuple(range(20262101, 20262121))
