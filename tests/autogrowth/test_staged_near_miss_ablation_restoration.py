...
def test_tg28k_smoke_stamps_checkpoint_and_purity_fields(tmp_path: Path) -> None:
    ...
    assert payload["checkpoint"] == "TG28k_staged_near_miss_ablation_restoration"
    ...
    assert payload["purity_boundary"]["near_miss_entries_used_as_provider"] is False
