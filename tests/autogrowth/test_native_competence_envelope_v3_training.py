...
def test_v3_preserves_frozen_hash_and_locks_additive_specialization_extension() -> None:
    ...
    # The current additive learner state is independently frozen by the specialization
    # manifest; V3 itself was not rerun.
