...
def test_tg29a_smoke_reports_online_no_cheat_fields(tmp_path: Path) -> None:
    result = run_tiny_online_krk_episode_runner(
    ...
    assert payload["checkpoint"] == "TG29a_tiny_online_krk_episode_runner"
    ...
    assert "phase_sequence_counts" in decision
