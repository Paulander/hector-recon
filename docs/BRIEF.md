...
Phase 2.9e pure ecological Stage B probe: sealed two-arm run on clean 128 heldout, 32-row train prefix for runtime, exact judge post-hoc only. Arm1 unguided internal triggers produced load-bearing counts 1/0/1 and wins 80/68/82; birth/death stayed bounded at 149/145/4, 156/152/4, 140/136/4 births/pruned/survivors, leaks 0. Survivors with positive ablation: seed31 `rook_attacked_after=0 AND to_file_edge_distance=2` delta +1; seed33 `bk_neighbor_ne_available zero AND bk_neighbor_se_available zero` delta +1. Arm2 guided-residual control was quarantined and produced 0/0/0 load-bearing. Interpretation: Arm1>0 gives a weak real discovery signal, still below official sealed flat 93/92/92; next is step 5 full graph-native plasticity migration/economy.
