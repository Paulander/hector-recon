...
- Suggested next step: external audit before adding more mechanisms. The audit should focus on why fence boundary states remain safe/no-progress despite filtered and small unfiltered signals, and whether the current ACTION feature/credit representation can discover the needed bridge without a new local sensor or temporal primitive. Do not proceed to broad KRK, ecological spawning, or M4 consolidation.
