...
- Next checkpoint: focus fence boundary/near-miss transfer while preserving edge stability. Do not proceed to broad KRK, ecological spawning, or M4 consolidation until fence has safe unfiltered and boundary evidence at larger scale and foundation regression stays clean.
