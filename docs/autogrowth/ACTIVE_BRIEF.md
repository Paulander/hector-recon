...
- Next checkpoint: inspect fence boundary failure slices and add a more informative local feature/credit signal before another larger run. Do not proceed to broad KRK, ecological spawning, or M4 consolidation until fence boundary transfer is nonzero and repeats safely.
