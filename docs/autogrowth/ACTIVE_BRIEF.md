...
- Next checkpoint: inspect TG26 edge/fence failure slices, especially rook-loss and confinement-regression actions, then improve local safety/gating or reward balance inside the staged curriculum runner.
