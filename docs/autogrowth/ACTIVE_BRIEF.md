...
- Suggested next step: external audit or a focused failure audit before adding SCRIPT/LAG or broad KRK. The audit should inspect why fence boundary positions remain safe/no-progress under terminal-native features, whether handoff confidence is too sparse/expensive, and whether the next primitive should be temporal/compositional terminals rather than more one-step feature terminals. Do not proceed to broad KRK, ecological spawning, SCRIPT/LAG expansion, or fence M4 consolidation without that decision.
